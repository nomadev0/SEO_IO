...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Domain overview', href: '/backlinks#domain-overview' },
  { label: 'Organic research', href: '/backlinks#organic-research' },
  { label: 'Keyword gap', href: '/backlinks#keyword-gap' },
  { label: 'Backlink gap', href: '/backlinks#backlink-gap' },
  { label: 'Site audit', href: '/#site-audit' },
  { label: 'Content ideas', href: '/#content' },
  { label: 'Reports & alerts', href: '/#reports' },
];
    ...
    <aside className="hidden w-72 flex-col bg-gradient-to-b from-neutral-900 via-neutral-900 to-neutral-800 px-6 py-8 text-white lg:flex">
      <div className="rounded-3xl bg-gradient-to-br from-indigo-500 to-violet-500 p-6 shadow-lg">
        ...
        <p className="mt-4 text-sm text-white/80">
          Audita, optimiza y monitoriza la salud SEO de tus proyectos desde un tablero único.
        </p>
      </div>
            ...
            >
              ...
              <span
                className={`inline-flex h-6 w-6 items-center justify-center rounded-full text-xs ${
                  active ? 'bg-neutral-900 text-white' : 'bg-white/10 text-white/70'
                }`}
              >
                •
              </span>
      ...
      <div className="mt-8 rounded-3xl bg-white/10 p-5 text-sm text-white/80 shadow-inner">
        ...
        <p className="mt-3">
          Los crawls automáticos se ejecutarán esta noche. Recibirás alertas si detectamos issues críticos.
        </p>
      </div>
    </aside>
  );
